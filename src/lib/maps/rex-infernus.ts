        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              instruction:
                "**No reproducible method is known yet.** Everything below is the current hunt lead, not a proven step \u2014 do not burn a long run on it.\n\nThe working theory is that each Shadowsmith's corruption relates to the elemental weakness of a special enemy tied to that Shadowsmith, and that Veytharion's interaction happens at the **blue pool/portal** opened by the cube puzzle.\n\n**Strongest current guess:** Light Mend, possibly on a Ravager, killed at or beside the blue portal.\n\nIf you want to test it:\n\n- Solve the cube puzzle and open the blue portal area.\n- Put **Light Mend** on a normal weapon.\n- Bring the special enemy to the portal.\n- Get actual Light Mend procs to land the kill \u2014 not just kills from a gun that happens to have it equipped.\n- Watch the pool for a drop, an object appearing, a colour change, dialogue, or a pickup prompt.\n\nDo not mistake side-Easter-egg weapon interactions (such as the corrupted Novaline) for this step.",
              solidMarkers: true,
              locations: [{ position: { x: 37.5, y: 39.4 } }],
            },
          ],
